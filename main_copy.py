...
if __name__ == '__main__':
    ...
    model_name = 'reid.pth' #reid , net_last resnet50_optimizer_120
    ...
    # Load the ONNX model
    # model = onnx.load(os.path.join(os.path.dirname(os.path.abspath(__file__)),'models/resnet101_vpu_79_final.onnx'))
    #
    ...
    for st in set:
        ...
        # Results file
        file_results = os.path.join(results_dir, s, 's02.txt')
            ...
            for f in range(1,  mtmc.max_frame[s] + 1):
                ...
                for c in cameras:
                    ...
                    for i in range(sct_f_data.shape[0]):
                        ...
                        bbox_padded = aicc.data_transform((bbox_padded))
                        features_np=feat.extract(bbox_padded )
